queues = {0: ['Custom', ''], 2: ["Summoner's Rift", '5v5 Blind Pick'], 4: ["Summoner's Rift", '5v5 Ranked Solo'],
          6: ["Summoner's Rift", '5v5 Ranked Premade'], 7: ["Summoner's Rift", 'Co-op vs AI'],
          8: ['Twisted Treeline', '3v3 Normal'], 9: ['Twisted Treeline', '3v3 Ranked Flex'],
          14: ["Summoner's Rift", '5v5 Draft Pick'], 16: ['Crystal Scar', '5v5 Dominion Blind Pick'],
          17: ['Crystal Scar', '5v5 Dominion Draft Pick'], 25: ['Crystal Scar', 'Dominion Co-op vs AI'],
          31: ["Summoner's Rift", 'Co-op vs AI Intro Bot'], 32: ["Summoner's Rift", 'Co-op vs AI Beginner Bot'],
          33: ["Summoner's Rift", 'Co-op vs AI Intermediate Bot'], 41: ['Twisted Treeline', '3v3 Ranked Team'],
          42: ["Summoner's Rift", '5v5 Ranked Team'], 52: ['Twisted Treeline', 'Co-op vs AI'],
          61: ["Summoner's Rift", '5v5 Team Builder'], 65: ['Howling Abyss', '5v5 ARAM'],
          70: ["Summoner's Rift", 'One for All'], 72: ['Howling Abyss', '1v1 Snowdown Showdown'],
          73: ['Howling Abyss', '2v2 Snowdown Showdown'], 75: ["Summoner's Rift", '6v6 Hexakill'],
          76: ["Summoner's Rift", 'Ultra Rapid Fire'], 78: ['Howling Abyss', 'One For All: Mirror Mode'],
          83: ["Summoner's Rift", 'Co-op vs AI Ultra Rapid Fire'], 91: ["Summoner's Rift", 'Doom Bots Rank 1'],
          92: ["Summoner's Rift", 'Doom Bots Rank 2'], 93: ["Summoner's Rift", 'Doom Bots Rank 5'],
          96: ['Crystal Scar', 'Ascension'], 98: ['Twisted Treeline', '6v6 Hexakill'],
          100: ["Butcher's Bridge", '5v5 ARAM'], 300: ['Howling Abyss', 'Legend of the Poro King'],
          310: ["Summoner's Rift", 'Nemesis'], 313: ["Summoner's Rift", 'Black Market Brawlers'],
          315: ["Summoner's Rift", 'Nexus Siege'], 317: ['Crystal Scar', 'Definitely Not Dominion'],
          318: ["Summoner's Rift", 'ARURF'], 325: ["Summoner's Rift", 'All Random'],
          400: ["Summoner's Rift", '5v5 Draft Pick'], 410: ["Summoner's Rift", '5v5 Ranked Dynamic'],
          420: ["Summoner's Rift", '5v5 Ranked Solo'], 430: ["Summoner's Rift", '5v5 Blind Pick'],
          440: ["Summoner's Rift", '5v5 Ranked Flex'], 450: ['Howling Abyss', '5v5 ARAM'],
          460: ['Twisted Treeline', '3v3 Blind Pick'], 470: ['Twisted Treeline', '3v3 Ranked Flex'],
          600: ["Summoner's Rift", 'Blood Hunt Assassin'], 610: ['Cosmic Ruins', 'Dark Star: Singularity'],
          800: ['Twisted Treeline', 'Co-op vs. AI Intermediate Bot'],
          810: ['Twisted Treeline', 'Co-op vs. AI Intro Bot'], 820: ['Twisted Treeline', 'Co-op vs. AI Beginner Bot'],
          830: ["Summoner's Rift", 'Co-op vs. AI Intro Bot'], 840: ["Summoner's Rift", 'Co-op vs. AI Beginner Bot'],
          850: ["Summoner's Rift", 'Co-op vs. AI Intermediate Bot'], 900: ["Summoner's Rift", 'ARURF'],
          910: ['Crystal Scar', 'Ascension'], 920: ['Howling Abyss', 'Legend of the Poro King'],
          940: ["Summoner's Rift", 'Nexus Siege'], 950: ["Summoner's Rift", 'Doom Bots Voting'],
          960: ["Summoner's Rift", 'Doom Bots Standard'], 980: ['Valoran City Park', 'Star Guardian Invasion: Normal'],
          990: ['Valoran City Park', 'Star Guardian Invasion: Onslaught'], 1000: ['Overcharge', 'PROJECT: Hunters'],
          1010: ["Summoner's Rift", 'Snow ARURF games'], 1020: ["Summoner's Rift", "One for All"]}

runes = [{"id": 8134, "key": "IngeniousHunter", "name": "Ingenious Hunter",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/IngeniousHunter/IngeniousHunter.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 8299, "key": "LastStand", "name": "Last Stand",
                                          ...
                                          "icon": "ASSETS/Perks/Styles/Sorcery/LastStand/LastStand.dds",
                                          "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8453, "key": "Revitalize", "name": "Revitalize",
          ...
          "icon": "ASSETS/Perks/Styles/Resolve/Revitalize/Revitalize.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8135, "key": "RavenousHunter", "name": "Ravenous Hunter",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Domination/RavenousHunter/RavenousHunter.dds",
                                       "runePathId": 8100, "runePathName": "Domination"},
         {"id": 8410, "key": "ApproachVelocity", "name": "Approach Velocity",
          ...
          "icon": "ASSETS/Perks/Styles/Resolve/ApproachVelocity/ApproachVelocity.dds", "runePathId": 8300,
          "runePathName": "Inspiration"}, {"id": 9103, "key": "LegendBloodline", "name": "Legend: Bloodline",
                                           ...
                                           "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8014, "key": "CoupDeGrace", "name": "Coup de Grace",
          "shortDesc": "Deal more damage to low health enemy champions.",
          "longDesc": "Deal @BonusPercentDamage.0 *100@% more damage to champions who have less than @EnemyHealthPercentageThreshold*100@% health.<br><br>Additionally, takedowns on champions grant an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @AdaptiveForce.-1*0.6@ Attack Damage or @AdaptiveForce@ Ability Power for @Duration@s.",
          "icon": "ASSETS/Perks/Styles/Precision/CoupDeGrace/CoupDeGrace.dds", "runePathId": 8000,
          "runePathName": "Precision"}, {"id": 8451, "key": "Overgrowth", "name": "Overgrowth",
                                         ...
                                         "icon": "ASSETS/Perks/Styles/Resolve/Overgrowth/Overgrowth.dds",
                                         "runePathId": 8400, "runePathName": "Resolve"},
         {"id": 9101, "key": "Overheal", "name": "Overheal", "shortDesc": "Excess healing on you becomes a shield.",
          ...
          "icon": "ASSETS/Perks/Styles/Precision/Overheal.dds", "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8210, "key": "Transcendence", "name": "Transcendence",
          ...
          "longDesc": "Gain @MaxCDR*100@% CDR when you reach level @LevelToTurnOn@.<br><br>Each percent of CDR exceeding the CDR limit is converted to an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @AdaptiveForce.-1*0.6@ Attack Damage or @AdaptiveForce@ Ability Power.",
          "icon": "ASSETS/Perks/Styles/Sorcery/Transcendence/Transcendence.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8138, "key": "EyeballCollection", "name": "Eyeball Collection",
                                       ...
                                       "longDesc": "Collect eyeballs for champion and ward takedowns. Gain an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @AdaptiveForce.-1*0.6@ Attack Damage or @AdaptiveForce@ Ability Power, per eyeball collected. <br><br>Upon completing your collection at @MaxEyeballs@ eyeballs, additionally gain an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @CompletionBonus.-1*0.6@ Attack Damage, or @CompletionBonus@ Ability Power.<br><br>Collect @StacksPerTakedown@ eyeballs per champion kill, @StacksPerAssist@ per assist, and @StacksPerWard@ per ward takedown.",
                                       "icon": "ASSETS/Perks/Styles/Domination/EyeballCollection/EyeballCollection.dds",
                                       "runePathId": 8100, "runePathName": "Domination"},
         {"id": 8017, "key": "CutDown", "name": "Cut Down",
          ...
          "icon": "ASSETS/Perks/Styles/Precision/CutDown/CutDown.dds", "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8139, "key": "TasteOfBlood", "name": "Taste of Blood",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/TasteOfBlood/GreenTerror_TasteOfBlood.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 8136, "key": "ZombieWard", "name": "Zombie Ward",
                                          ...
                                          "longDesc": "After killing a ward, a friendly Zombie Ward is raised in its place. Additionally, when your wards expire, they reanimate as Zombie Wards.<br><br>Zombie Wards are visible, last for @WardDurationTooltipMin@ - @WardDuration@s and don't count towards your ward limit.",
                                          "icon": "ASSETS/Perks/Styles/Domination/ZombieWard/ZombieWard.dds",
                                          "runePathId": 8100, "runePathName": "Domination"},
         {"id": 9104, "key": "LegendAlacrity", "name": "Legend: Alacrity",
          ...
          "icon": "ASSETS/Perks/Styles/Precision/Legend_Heroism.dds", "runePathId": 8000, "runePathName": "Precision"},
         {"id": 9105, "key": "LegendTenacity", "name": "Legend: Tenacity",
          ...
          "icon": "ASSETS/Perks/Styles/Precision/Legend_Tenacity.dds", "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8214, "key": "SummonAery", "name": "Summon Aery",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/SummonAery/SummonAery.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8010, "key": "Conqueror", "name": "Conqueror",
                                       "shortDesc": "After @ThresholdTime@ seconds in combat, your first attack against an enemy champion grants you AD and converts some of your damage to true damage.",
                                       "longDesc": "After @ThresholdTime@ seconds in combat, your first attack against an enemy champion grants you @BaseAD@ - @MaxAD@ AD, based on level, for @BuffDuration@ seconds and converts @TrueDamageBase*100@% of your damage to champions to true damage.<br><br><rules>Melee Only: Damaging enemy champions refreshes this buff.</rules>",
                                       "icon": "ASSETS/Perks/Styles/Precision/Conqueror/Conqueror.dds",
                                       "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8008, "key": "LethalTempo", "name": "Lethal Tempo",
          ...
          "longDesc": "@LeadInDelay.1@s after damaging a champion gain @AttackSpeedMin*100@ - @AttackSpeedMax*100@% Attack Speed (based on level) for @AttackSpeedBuffDurationMin@s. Attacking a champion extends the effect to @AttackSpeedBuffDurationMax@s.<br><br>Cooldown: @Cooldown@s<br><br>Lethal Tempo allows you to temporarily exceed the attack speed limit.",
          "icon": "ASSETS/Perks/Styles/Precision/FlowofBattle/FlowofBattleTemp.dds", "runePathId": 8000,
          "runePathName": "Precision"}, {"id": 8009, "key": "PresenceOfMind", "name": "Presence of Mind",
                                         "shortDesc": "Takedowns restore @PercentManaRestore*100@% of your maximum mana and refund @UltimateCooldownRefund*100@% of your ultimate's cooldown.",
                                         "longDesc": "Takedowns restore @PercentManaRestore*100@% of your maximum mana and refund @UltimateCooldownRefund*100@% of your ultimate's cooldown.",
                                         "icon": "ASSETS/Perks/Styles/Precision/LastResort/LastResortIcon.dds",
                                         "runePathId": 8000, "runePathName": "Precision"},
         {"id": 8465, "key": "Guardian", "name": "Guardian",
         ...
         {"id": 8143, "key": "SuddenImpact", "name": "Sudden Impact",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/SuddenImpact/SuddenImpact.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 9111, "key": "Triumph", "name": "Triumph",
                                          ...
                                          "icon": "ASSETS/Perks/Styles/Precision/DangerousGame.dds", "runePathId": 8000,
                                          "runePathName": "Precision"},
         {"id": 8463, "key": "FontOfLife", "name": "Font of Life",
          ...
          "icon": "ASSETS/Perks/Styles/Resolve/FontOfLife/FontOfLife.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8105, "key": "RelentlessHunter", "name": "Relentless Hunter",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Domination/RelentlessHunter/RelentlessHunter.dds",
                                       "runePathId": 8100, "runePathName": "Domination"},
         {"id": 8347, "key": "CosmicInsight", "name": "Cosmic Insight",
          ...
          "icon": "ASSETS/Perks/Styles/Inspiration/CosmicInsight/CosmicInsight.dds", "runePathId": 8300,
          "runePathName": "Inspiration"}, {"id": 8226, "key": "ManaflowBand", "name": "Manaflow Band",
                                           "shortDesc": "Hitting an enemy champion with an ability permanently increases your maximum mana by @ManaIncrease@, up to @MaxManaIncrease@ mana.<br><br>After reaching @MaxManaIncrease@ bonus mana, restore @PercentManaRestore*100@% of your missing mana every @PercentManaRestoreCooldown@ seconds.",
                                           "longDesc": "Hitting an enemy champion with an ability permanently increases your maximum mana by @ManaIncrease@, up to @MaxManaIncrease@ mana.<br><br>After reaching @MaxManaIncrease@ bonus mana, restore @PercentManaRestore*100@% of your missing mana every @PercentManaRestoreCooldown@ seconds.<br><br>Cooldown: @Cooldown.0@ seconds",
                                           "icon": "ASSETS/Perks/Styles/Sorcery/ManaflowBand/ManaflowBand.dds",
                                           "runePathId": 8200, "runePathName": "Sorcery"},
         {"id": 8304, "key": "MagicalFootwear", "name": "Magical Footwear",
          ...
          "longDesc": "You get free Slightly Magical Boots at @GiveBootsAtMinute@ min, but you cannot buy boots before then. For each takedown you acquire the boots @SecondsSoonerPerTakedown@s sooner.<br><br>Slightly Magical Boots give you an additional +@AdditionalMovementSpeed@ Movement Speed.",
          "icon": "ASSETS/Perks/Styles/Inspiration/MagicalFootwear/MagicalFootwear.dds", "runePathId": 8300,
          "runePathName": "Inspiration"}, {"id": 8345, "key": "BiscuitDelivery", "name": "Biscuit Delivery",
                                           ...
                                           "longDesc": "Biscuit Delivery: Gain a Total Biscuit of Everlasting Will every @BiscuitMinuteInterval@ mins, until @SwapOverMinute@ min.<br><br>Biscuits restore @HealthHealPercent.0*100@% of your missing health and mana. Consuming any Biscuit increases your mana cap by @PermanentMana@ mana permanently. <br><br><i>Manaless:</i> Champions without mana restore @HealthHealPercentManaless.0*100@% missing health instead.",
                                           "icon": "ASSETS/Perks/Styles/Inspiration/BiscuitDelivery/BiscuitDelivery.dds",
                                           "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8224, "key": "NullifyingOrb", "name": "Nullifying Orb",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/NullifyingOrb/Pokeshield.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8021, "key": "FleetFootwork", "name": "Fleet Footwork",
         ...
         {"id": 8112, "key": "Electrocute", "name": "Electrocute",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/Electrocute/Electrocute.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 8233, "key": "AbsoluteFocus", "name": "Absolute Focus",
                                          ...
                                          "longDesc": "While above @HealthPercent*100@% health, gain an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of up to @MaxAdaptive.-1*0.6@ Attack Damage or @MaxAdaptive@ Ability Power (based on level). <br><br>Grants @MinAdaptive.-1*0.6@ Attack Damage or @MinAdaptive@ Ability Power at level 1. ",
                                          "icon": "ASSETS/Perks/Styles/Sorcery/AbsoluteFocus/AbsoluteFocus.dds",
                                          "runePathId": 8200, "runePathName": "Sorcery"},
         {"id": 8234, "key": "Celerity", "name": "Celerity",
          ...
          "longDesc": "Gain @PercentMS.0@% increased Movement Speed.<br>Your Bonus Movement Speed is converted to Attack Damage or Ability Power, <font color='#48C4B7'>adaptive</font> at a rate of @AdaptiveAD*8@% Attack Damage or @AdaptiveAP*8@% Ability Power.",
          "icon": "ASSETS/Perks/Styles/Sorcery/Celerity/CelerityTemp.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8352, "key": "TimeWarpTonic", "name": "Time Warp Tonic",
                                       "shortDesc": "Your potions, biscuits and elixirs last @PotionDuration*100@% longer, and you gain @BonusMS*100@% Movement Speed while under their effects.",
                                       "longDesc": "Your potions, biscuits and elixirs last @PotionDuration*100@% longer, and you gain @BonusMS*100@% Movement Speed while under their effects.",
                                       "icon": "ASSETS/Perks/Styles/Inspiration/TimeWarpTonic/TimeWarpTonic.dds",
                                       "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8473, "key": "BonePlating", "name": "Bone Plating",
          "shortDesc": "After taking damage from an enemy champion, the next @BlockCount@ spells or attacks you receive from them deal @BlockBase@-@BlockMax@ less damage.<br><br>Duration: @BlockDuration@s<br>Cooldown: @Cooldown@s",
          "longDesc": "After taking damage from an enemy champion, the next @BlockCount@ spells or attacks you receive from them deal @BlockBase@-@BlockMax@ less damage.<br><br>Duration: @BlockDuration@s<br>Cooldown: @Cooldown@s",
          "icon": "ASSETS/Perks/Styles/Resolve/BonePlating/BonePlating.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8232, "key": "Waterwalking", "name": "Waterwalking",
         ...
         {"id": 8237, "key": "Scorch", "name": "Scorch",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/Scorch/Scorch.dds", "runePathId": 8200, "runePathName": "Sorcery"},
         {"id": 8359, "key": "Kleptomancy", "name": "Kleptomancy",
          ...
          "icon": "ASSETS/Perks/Styles/Inspiration/Kleptomancy/Kleptomancy.dds", "runePathId": 8300,
          "runePathName": "Inspiration"}, {"id": 8313, "key": "PerfectTiming", "name": "Perfect Timing",
                                           ...
                                           "longDesc": "Start the game with a Commencing Stopwatch that transforms into a Stopwatch after @InitialCooldown.0@ min. Stopwatch has a one time use Stasis effect.<br><br>Reduces the cooldown of Zhonya's Hourglass, Guardian Angel, and Gargoyle Stoneplate by @PercentGAZhonyasCDR.0*100@%.",
                                           "icon": "ASSETS/Perks/Styles/Inspiration/PerfectTiming/PerfectTiming.dds",
                                           "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8236, "key": "GatheringStorm", "name": "Gathering Storm",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/GatheringStorm/GatheringStorm.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8351, "key": "GlacialAugment", "name": "Glacial Augment",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Inspiration/GlacialAugment/GlacialAugment.dds",
                                       "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8472, "key": "Chrysalis", "name": "Chrysalis",
          "shortDesc": "Start the game with an extra @StartingHealth@ health. At @MaxTakedowns@ takedowns, consume that health to gain an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @AdaptiveForce.-1*0.6@ Attack Damage or @AdaptiveForce@ Ability Power.",
          "longDesc": "Start the game with an extra @StartingHealth@ health. At @MaxTakedowns@ takedowns, consume that health to gain an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of @AdaptiveForce.-1*0.6@ Attack Damage or @AdaptiveForce@ Ability Power.",
          "icon": "ASSETS/Perks/Styles/Resolve/Chrysalis/Chrysalis.dds", "runePathId": 8400, "runePathName": "Resolve"},
         {"id": 8230, "key": "PhaseRush", "name": "Phase Rush",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/PhaseRush/PhaseRush.dds", "runePathId": 8200, "runePathName": "Sorcery"},
         {"id": 8429, "key": "Conditioning", "name": "Conditioning",
          ...
          "longDesc": "After @MinutesRequired@ min gain +@ArmorBase@ Armor and +@MRBase@ Magic Resist and increase your Armor and Magic Resist by @ExtraResist@%.",
          "icon": "ASSETS/Perks/Styles/Resolve/Conditioning/Conditioning.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8306, "key": "HextechFlashtraption", "name": "Hextech Flashtraption",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Inspiration/HextechFlashtraption/HextechFlashtraption.dds",
                                       "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8229, "key": "ArcaneComet", "name": "Arcane Comet",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/ArcaneComet/ArcaneComet.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8321, "key": "FuturesMarket", "name": "Future's Market",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Inspiration/FuturesMarket/FuturesMarket.dds",
                                       "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8124, "key": "Predator", "name": "Predator",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/Predator/Predator.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 8242, "key": "Unflinching", "name": "Unflinching",
                                          ...
                                          "icon": "ASSETS/Perks/Styles/Sorcery/Unflinching/Unflinching.dds",
                                          "runePathId": 8400, "runePathName": "Resolve"},
         {"id": 8243, "key": "TheUltimateHat", "name": "The Ultimate Hat",
          ...
          "icon": "ASSETS/Perks/Styles/Sorcery/TheUltimateHat/TheUltimateHat.dds", "runePathId": 8200,
          "runePathName": "Sorcery"}, {"id": 8446, "key": "Demolish", "name": "Demolish",
                                       "shortDesc": "Charge up a powerful attack against a tower while near it.",
                                       "longDesc": "Charge up a powerful attack against a tower over @TotalDemolishTime@s, while within @DistanceToTower@ range of it. The charged attack deals @OutputDamagePerStack@ (+@MaxHealthPercentDamage.0 * 100@% of your max health) bonus physical damage.<br><br>Cooldown: @CooldownSeconds@s",
                                       "icon": "ASSETS/Perks/Styles/Resolve/Demolish/Demolish.dds", "runePathId": 8400,
         ...
         {"id": 8128, "key": "DarkHarvest", "name": "Dark Harvest",
          ...
          "icon": "ASSETS/Perks/Styles/Domination/DarkHarvest/DarkHarvest.dds", "runePathId": 8100,
          "runePathName": "Domination"}, {"id": 8326, "key": "UnsealedSpellbook", "name": "Unsealed Spellbook",
                                          ...
                                          "icon": "ASSETS/Perks/Styles/Inspiration/UnsealedSpellbook/UnsealedSpellbook.dds",
                                          "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8444, "key": "SecondWind", "name": "Second Wind",
          ...
          "icon": "ASSETS/Perks/Styles/Resolve/SecondWind/SecondWind.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8126, "key": "CheapShot", "name": "Cheap Shot",
                                       ...
                                       "icon": "ASSETS/Perks/Styles/Domination/CheapShot/CheapShot.dds",
                                       "runePathId": 8100, "runePathName": "Domination"},
         {"id": 8005, "key": "PressTheAttack", "name": "Press the Attack",
          ...
          "icon": "ASSETS/Perks/Styles/Precision/PressTheAttack/PressTheAttack.dds", "runePathId": 8000,
          "runePathName": "Precision"}, {"id": 8120, "key": "GhostPoro", "name": "Ghost Poro",
                                         "shortDesc": "When you enter brush, a poro appears. It will stay behind to give you vision.",
                                         "longDesc": "Enter a brush to summon a poro after a brief channel. The poro will stay behind to give you vision until you summon a new one.<br><br>If an enemy enters brush with a poro in it, they scare it away, putting Ghost Poro on a @Cooldown@s cooldown.<br><br>Poro channel is interrupted if you take damage.",
                                         "icon": "ASSETS/Perks/Styles/Domination/GhostPoro/GhostPoro.dds",
                                         "runePathId": 8100, "runePathName": "Domination"},
         {"id": 8439, "key": "Aftershock", "name": "Aftershock",
          ...
          "longDesc": "After immobilizing an enemy champion, increase your Armor and Magic Resist by @FlatResists@ - @FlatResistMaximum@ for @DelayBeforeBurst.1@s. Then explode, dealing magic damage to nearby enemies.<br><br>Damage: @StartingBaseDamage@ - @MaxBaseDamage@ (+@HealthRatio.-1@% of your maximum health) (+@DamageRatioAD*100@% of your bonus attack damage) (+@DamageRatioAP*100@% of your ability power)<br>Cooldown: @Cooldown@s",
          "icon": "ASSETS/Perks/Styles/Resolve/VeteranAftershock/VeteranAftershock.dds", "runePathId": 8400,
          "runePathName": "Resolve"}, {"id": 8316, "key": "MinionDematerializer", "name": "Minion Dematerializer",
                                       "shortDesc": "Start the game with @GainedMinionKillers@ Minion Dematerializers. Killing minions with the item gives permanent bonus damage vs. that minion type.",
                                       "longDesc": "Start the game with @GainedMinionKillers@ Minion Dematerializers that kill and absorb lane minions instantly. Minion Dematerializers are on cooldown for the first @InitialCooldown@s of the game.<br><br>Absorbing a minion increases your damage by +@DamageBonusForAnyAbsorbed.0*100@% against that type of minion permanently, and an extra +@DamageBonusPerAdditionalAbsorbed.0*100@% for each additional minion of that type absorbed.<br>",
                                       "icon": "ASSETS/Perks/Styles/Inspiration/MinionDematerializer/MinionDematerializer.dds",
                                       "runePathId": 8300, "runePathName": "Inspiration"},
         {"id": 8437, "key": "GraspOfTheUndying", "name": "Grasp of the Undying",
          ...
          "longDesc": "Every @TriggerTime@s in combat, your next basic attack on a champion will:<li>Deal bonus magic damage equal to @PercentHealthDamage.0@% of your max health</li><li>Heals you for @PercentHealthHeal.0*100@% of your max health</li><li>Permanently increase your health by @MaxHealthPerProc@</li><br><rules><i>Ranged Champions:</i> Damage, healing, and permanent health gained reduced by @RangedPenaltyMod*100@%.</rules><br>",
          "icon": "ASSETS/Perks/Styles/Resolve/GraspOfTheUndying/GraspOfTheUndying.dds", "runePathId": 8400,
          "runePathName": "Resolve"}]
